...

{
	...
	if(argc >= 4)
	{	
		//Optionen rausfiltern und �bergeben
		//H = Hide
		//E = Exit
		//M = Messages
		...
		//Das OutputVerzeichnis �bergeben
		char Output[200];
		...
		//Die Logdateien/Verzeichnisse �bergeben
		string Temp;
		for(z = 3; z < argc; z++)
		{
			...
			#endif
			Temp += argv[z];
			//wenn es ein Verzeichnis ist, �berpr�fen ob ein / am Ende ist
